...
\begin{itemize}
    ...
    \item These commits that were committed after the bug report was opened in Launchpad, according to to \'Sliwerski et al. ~\cite{sliwerski2005changes}.
\end{itemize}
...
\gema{Defect models which identify defect-prone software models  could improve their recall and precision predicting defect-prones modules whereas they have into account our study[1, "An Extensive Comparison of Bug Prediction Approaches", 17, 27, 33, 34, 36, "BugCache for Inspections: Hit or Miss?", “Predicting Defects for Eclipse,”]}
